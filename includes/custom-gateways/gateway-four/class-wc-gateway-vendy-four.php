...
class WC_Gateway_Vendy_Four extends WC_Gateway_Custom_Vendy {
	...
	/**
	 * WC_Gateway_Vendy_Four constructor.
	 */
	public function __construct() {
		...
		if ( empty( $gateway_title ) ) {
			$gateway_title = __( 'Four', 'woo-vendy' );
		}
		...
		$this->saved_cards = $this->vendy_settings['saved_cards'] === 'yes' ? true : false;
